...
### This repository is Digital Ohmmeter for measures electrical resistance.
The S1 and S2 keys are used to set the measurement range in ohms and kiloohms.
and R2 the resistance of the load or (unknown Resistor) to be measured.
